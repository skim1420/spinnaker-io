...
![image](https://files.readme.io/06CDzZS2RhmmJ0PaMFgy_flow.png)
...
![image](https://files.readme.io/AP5tbGUOQb6jKbdpEEvw_jenkins1.png)
...
![image](https://files.readme.io/dzK4KjTrTmScMZINAHDi_s3.png)
...
![image](https://files.readme.io/T3V7FvrURoiMxTWuHJyI_jenkins2.png)
...
![image](https://files.readme.io/IlYtgmKXRVCm46jNJE8d_build.png)
...
![image](https://files.readme.io/0i135ajLTTybra8MxFCq_create.png)
...
![image](https://files.readme.io/vCrPy5AURDWrwUZxTDhW_group1.png)
...
![image](https://files.readme.io/hXeKfK4SSGAER0NuFBRM_group2.png)



Select our group as ingress source

![image](https://files.readme.io/6sPtJxDQ6OoiD6bPiP4R_group3.png)
...
![image](https://files.readme.io/ZtHWZISV6bgLxwYJDGQ0_group4.png)
...
![image](https://files.readme.io/jhi31gsGSXWF3qY2Hnqp_pipe1.png)
...
![image](https://files.readme.io/ZboJ8cQKyNeE9AurMVcA_pipe2.png)
...
![image](https://files.readme.io/sz1rlPC4RcawcQbC8x3O_bake.png)
...
![image](https://files.readme.io/Wa2w0ElbRasgRfAtVQPw_pipe4.png)


Click "add server group" and configure the server group.

![image](https://files.readme.io/yGILeBAxQjeHeb6f1ZPc_pipe5.png)


Our app is fairly lightweight so t2.micro will be fine for instance type.

![image](https://files.readme.io/j9qCCROjTBO6PigsAD0w_pipe6.png)
...
![image](https://files.readme.io/iKq06UxsTmGALVuYmeJI_pipe7.png)
...
![image](https://files.readme.io/XNIDn9s0SRiXY0DPkKAq_pipe8.png)


We then can see our pipeline progress to the bake stage.

![image](https://files.readme.io/XTtxTWEPTgyOtKBgqi7r_pipe9.png)

Finally we reach our deploy stage where our server group is created.

![image](https://files.readme.io/e3w0ZpDT8GxHieNL7rY8_pipe10.png)
...
![image](https://files.readme.io/ftbR6GLrQMm09JGCkIRD_pipe11.png)
